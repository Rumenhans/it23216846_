          ...
          - generic [ref=e122]:
            ...
            - generic [ref=e124]:
              ...
              - button "Redo" [ref=e128] [cursor=pointer]:
                - img [ref=e129]
          - generic [ref=e131]:
            - textbox "Input Your Singlish Text Here." [active] [ref=e132]: zoom meeeting ekak
            - list [ref=e134]:
              - listitem [ref=e135] [cursor=pointer]: එකක්
              - listitem [ref=e136] [cursor=pointer]: එකක්ම
              - listitem [ref=e137] [cursor=pointer]: එකක්වත්
              - listitem [ref=e138] [cursor=pointer]: එකක් පාසා
              - listitem [ref=e139] [cursor=pointer]: එකක් ඇර එකක්
              - listitem [ref=e140] [cursor=pointer]: එකක් අනෙකකට බැඳුණ
              - listitem [ref=e141] [cursor=pointer]: එකක් හැර එකක් ළෙස
              - listitem [ref=e142] [cursor=pointer]: එකක් පිට එකක් තබනවා
              - listitem [ref=e143] [cursor=pointer]: එකක්ම බවට පැමිණෙනවා
              - listitem [ref=e144] [cursor=pointer]: එකක් අසභ්‍ය අර්ථ දෙකක් ඇති වාක්‍යය
              - listitem [ref=e145] [cursor=pointer]: එකඛ්
              - listitem [ref=e146] [cursor=pointer]: එඛක්
              - listitem [ref=e147] [cursor=pointer]: එඛඛ්
          - generic [ref=e148]:
            - button "Open File" [ref=e149] [cursor=pointer]:
              - img [ref=e150]
            - button "Copy" [ref=e152] [cursor=pointer]:
              - img [ref=e153]
            - button "Cut" [ref=e155] [cursor=pointer]:
              - img [ref=e156]
            - button "Paste" [ref=e158] [cursor=pointer]:
              - img [ref=e159]
            - button "Clear" [ref=e161] [cursor=pointer]:
              - img [ref=e162]
        - button "Swap Languages" [ref=e165] [cursor=pointer]:
          - img [ref=e166]
        - generic [ref=e168]:
          - generic [ref=e169]: Sinhala
          - generic [ref=e170]: zoom මේඑටින්ග් එකක්
          - generic [ref=e171]:
            - button "Copy" [ref=e172] [cursor=pointer]:
              - img [ref=e173]
            - button "Clear" [ref=e175] [cursor=pointer]:
              - img [ref=e176]
      - button "Clear" [ref=e179] [cursor=pointer]: 🗑️ Clear
```